...
This folder defines all source code for the 'gold_layers' pipeline:
...
* Take a look at the sample under "sample_users_gold_layers.py" to get familiar with the syntax.
